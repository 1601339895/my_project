...
from utils.loss_utils import FFTLoss, SSIMloss, PSNR_Loss
...
class PLTrainModel(pl.LightningModule):
    def __init__(self, opt):
        ...
        # # self.pnsr = PSNR_Loss(loss_weight=opt.pnsr_loss_weight)
    ...
    def training_step(self, batch, batch_idx):
        ...
        # # loss_pnsr = self.pnsr(restored, clean_patch)
    ...
    def configure_optimizers(self):
        ...
        optimizer = C_AdamW(self.parameters(), lr=2e-4, eps=1e-8)  # 自定义的优化器
...
# > train.log 2>&1 &
# nohup python src/train.py --model MyModel_S --batch_size 16 --trainset CDD11_all --num_gpus 3  --de_type denoise_15 denoise_25 denoise_50 dehaze derain  --data_file_dir /home/chujielie/hl/image_restoration/Data/ > train.log 2>&1 &
#  nohup python src/train.py --model MyModel_S --batch_size 16 --trainset CDD11_all --num_gpus 3  --de_type denoise_15 denoise_25 denoise_50 dehaze derain --ckpt_dir checkpoints_cdd11_all  --data_file_dir /home/chujielie/hl/image_restoration/Data/ > train.log 2>&1 &
# nohup python src/train.py --model MyModel_S --batch_size 16 --accum_grad 2  --epochs 200    --trainset CDD11_all --num_gpus 4  --de_type denoise_15 denoise_25 denoise_50 dehaze derain --ckpt_dir checkpoints_cdd11_200Epochs  --data_file_dir /home/chujielie/hl/image_restoration/Data/  > train.log 2>&1 &
