...
from STPG_G_MESE import STPG_G_MESE
from FD_MEE import FD_MEE
...
class IRmodel(nn.Module):
    def __init__(self, inp_channels=3, out_channels=3, dim = 48,
                 num_blocks = [4,4,6,8],num_refinement_blocks = 4,heads = [1,2,4,8],
