...
def train_options():
    ...
    if base_args.model == "LumiSenseMoEIR_S":
        parser = LumiSenseMoEIR_s(base_parser())
    elif base_args.model == "LumiSenseMoEIR":
        parser = LumiSenseMoEIR(base_parser())
    else:
