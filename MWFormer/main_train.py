...
def main():
    ...
    val_data_loader = data.DataLoader(test_dataset, batch_size=4, shuffle=True, num_workers=args.num_workers,
                                      pin_memory=True)  # batch size?
    ...
    for i_iter in tqdm(range(start_iter, args.num_steps)):
        ...
        try:  # raindrop
            ...
            raindrop_loader = data.DataLoader(raindrop_dataset, batch_size=10, shuffle=True,
