...
RESTORE_FROM_stylefilter = '/home/chujielie/hl/image_restoration/MWFormer/checkpoints/exp1/main_network-03-31-12-35_stylefilter_4000.pth' # 64 dimensions
SAVE_PRED_EVERY = 20000
SNAPSHOT_DIR = f'/home/chujielie/hl/image_restoration/MWFormer/checkpoints/exp1'   #save dir
TRAIN_DATA_DIR = '/home/chujielie/hl/image_restoration/MWFormer/allweather/'
...
def get_arguments():
    ...
    parser.add_argument("-file-name", type=str, default='main_train-restoration')
